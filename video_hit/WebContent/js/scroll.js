...
// Shuakua object setup
if (!Shuakua) var Shuakua = {}

// scrollToTop() - scroll window to the top
Shuakua.scrollToTop = function (e) {
...
// setup() - Shuakua init and setup
Shuakua.setup = function () {
    ...
    if ($("a#totop").length) Shuakua.scrollToTop("a#totop");
...
Shuakua.progress = function (el, val, max) {
    var duration = 400;
...
Shuakua.videoSupport = function (wrapper, videoURL, width, height) {
...
Shuakua.expandableRows = function () {
