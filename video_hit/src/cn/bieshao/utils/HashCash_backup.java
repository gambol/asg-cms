...
/**
 * Class for generation and parsing of <a
 * href="http://www.hashcash.org/">HashCash</a><br>
 ...
 * Please see the spec at: <a
 * href="http://www.hashcash.org/">http://www.hashcash.org/</a>
 * 
 * @author grrubin@gmail.com
 * @version 1.1
 */
public class HashCash_backup implements Comparable<HashCash_backup> {
     ...
     */
    public HashCash_backup(String cash) throws NoSuchAlgorithmException {
        myToken = cash;
    ...
    private HashCash_backup() throws NoSuchAlgorithmException {
    }
     ...
     *             If SHA1 is not a supported Message Digest
     */
    public static HashCash_backup mintCash(String resource, int value) throws NoSuchAlgorithmException {
     ...
     *             If SHA1 is not a supported Message Digest
     */
    public static HashCash_backup mintCash(String resource, int value, int version) throws NoSuchAlgorithmException {
        Calendar now = Calendar.getInstance(TimeZone.getTimeZone("GMT"));
     ...
     *             If SHA1 is not a supported Message Digest
     */
    public static HashCash_backup mintCash(String resource, Calendar date, int value) throws NoSuchAlgorithmException {
     ...
     *             If SHA1 is not a supported Message Digest
     */
    public static HashCash_backup mintCash(String resource, Calendar date, int value, int version)
            throws NoSuchAlgorithmException {
     ...
     *             If SHA1 is not a supported Message Digest
     */
    public static HashCash_backup mintCash(String resource, Map<String, List<String>> extensions, int value)
            throws NoSuchAlgorithmException {
        Calendar now = Calendar.getInstance(TimeZone.getTimeZone("GMT"));
     ...
     *             If SHA1 is not a supported Message Digest
     */
    public static HashCash_backup mintCash(String resource, Map<String, List<String>> extensions, int value, int version)
            throws NoSuchAlgorithmException {
        Calendar now = Calendar.getInstance(TimeZone.getTimeZone("GMT"));
     ...
     *             If SHA1 is not a supported Message Digest
     */
    public static HashCash_backup mintCash(String resource, Map<String, List<String>> extensions, Calendar date, int value)
            throws NoSuchAlgorithmException {
    ...
    public static HashCash_backup mintCash(String resource, Map<String, List<String>> extensions, Calendar date, int value,
        ...
        HashCash_backup result = new HashCash_backup();
    ...
    public boolean equals(Object obj) {
        if (obj instanceof HashCash_backup)
            ...
            if (null != tempList) {
                ...
                for (int i = 0; i < tempList.size(); i++) {
                    if (tempList.get(i).contains(":") || tempList.get(i).contains(";") || tempList.get(i).contains(","))
                        throw new IllegalArgumentException("Extension value contains an illegal character. "
                                + tempList.get(i));
                    if (i > 0)
                        result.append(",");
     ...
     */
    public int compareTo(HashCash_backup other) {
        if (null == other)
    ...
    public static void main(String[] args) throws Exception{
        HashCash_backup hc = new HashCash_backup();
        System.out.println(hc.mintCash("", 16, 0));
