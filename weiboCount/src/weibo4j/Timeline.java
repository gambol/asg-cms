...
public class Timeline extends Weibo{
	 ...
	 * 文档地址:http://open.weibo.com/wiki/2/statuses/count
	 * @param ids
	 * @return
	 * @throws WeiboException
	 */
	public JSONArray getRepostCountByIds(String ids) throws WeiboException {
		return client.get(WeiboConfig.getValue("baseURL")+"statuses/count.json",new PostParameter[]{
